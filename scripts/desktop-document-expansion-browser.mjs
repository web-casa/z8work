...
mockIPC(async(command,args)=>{
 ...
 if(command==='desktop_info') return {preparing:false,startup:[{id:'pandoc',phase:'ready',failure:null}],pending_imports:0,import_failure:null,workspace_error:null,temporary_cleanup:null,architecture:'test',engines:[],routes:[{input:'${format}',outputs:['txt']}],error:null,queue_error:null};
