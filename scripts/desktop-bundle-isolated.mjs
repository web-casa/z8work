...
try {
	...
	console.log(
		`All ${report.routes.length + report.imageExpansion.routes.length + report.documentExpansion.routes.length + report.audioExpansion.routes.length} routes passed using only the bundled runtime: ${output}`,
	);
} finally {
